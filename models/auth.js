...
module.exports ={
        ...
        try{
            ...
            await db.query('SELECT * FROM users WHERE email = ?', [email], async (error, results)=> {
                if (results.rowCount !==0) {
                    ...
                    db.query('INSERT INTO users (email, password) VALUES ?;', [email, password], async (error, results) => {
    ...
    login: async(req, res, next)=>{
        ...
        try{
            ...
            await db.query('SELECT * FROM users WHERE email = ?', [result.email],async (error, results)=> {
                console.log(results)
